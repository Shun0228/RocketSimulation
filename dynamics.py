...
class RocketSim:
    ...
    def __init__(self):
        """ Set default rocket/environment parameter """

        rocket_param = prm.rocket_param()
        env_param = prm.env_param()

        # Set default rocket parameter
        self.ref_len = rocket_param['len']
        self.diam = rocket_param['diam']
        self.mass_i = rocket_param['mass_i']
        self.mass_f = rocket_param['mass_f']
        self.CGlen_i = rocket_param['CGlen_i']
        self.CGlen_f = rocket_param['CGlen_f']
        self.Iyz_i = rocket_param['Iyz_i']
        self.Iyz_f = rocket_param['Iyz_f']
        self.CPlen = rocket_param['CPlen']
        self.Cd = rocket_param['Cd']
        self.Cna = rocket_param['Cna']
        self.Cmq = rocket_param['Cmq']
        self.op_flg = rocket_param['op_flg']
        self.vel_1st = rocket_param['vel_1st']
        self.vel_2nd = rocket_param['vel_2nd']
        self.Ix_i = rocket_param['Ix_i']
        self.Ix_f = rocket_param['Ix_f']
        ...
        motor_name = rocket_param['motor_name'] + ".txt"
        self.comb_time, self.linear_thrust = th.thrust_load(motor_name)

        # Set default environment parameter
        self.rail_len = env_param['rail_len']
        self.rail_elev = env_param['rail_elev']
        self.rail_azi = env_param['rail_azi']
        
        # Set wind parameter
        self.wind_ref = env_param['wind_ref']
        self.wind_dir = env_param['wind_dir']
    ...
    def set_mode(self, filename):
        """ Set simulation setting when this method is called """
    ...
    def set_param(self, filename):
        ...
        print("Date    : " + stdin_info.get("DATE"))
